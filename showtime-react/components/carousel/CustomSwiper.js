...
import { Virtual, Pagination, Scrollbar, Navigation, Autoplay, Parallax } from 'swiper/modules';
...
export default function CustomSwiper({ moviesData }) {
    ...
    >
        {moviesData.map((movie, i) => <SwiperSlide key={movie.id} virtualIndex={i}><CarouselCard movie={movie} /></SwiperSlide>)}
    </Swiper>
}
